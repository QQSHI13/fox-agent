...
| claude code | 2.1.278 (Claude Code) | 234.1 MB | 10 ms | **206 ms** | — | 181 MB |
| codex | codex-cli 0.155.1 | 370.5 MB (pkg) | 42 ms | **38 ms** | — | 49 MB |
| opencode v1 | 1.18.31 | 185.0 MB | 595 ms | **985 ms** | **40 ms** | 365 MB |
| opencode v2 | opencode2 v0.0.0-beta-19271 | 207.4 MB | 81 ms | **134 ms** | **64 ms** | 130 MB |
| jcode | jcode v0.86.0 (e589cbe5a) | 128.3 MB | 9 ms | **10 ms** | — | 23 MB |
| pi | 0.86.1 | 402.9 MB (pkg) | 231 ms | **294 ms** | **7 ms** | 139 MB |
| gemini cli | 0.60.0 | 102.0 MB (pkg) | 1498 ms | **1590 ms** | **0 ms** | 146 MB |
| copilot cli | GitHub Copilot CLI 1.0.86. | 166.8 MB (pkg) | 586 ms | **719 ms** | — | 47 MB |
| crush | crush version v0.96.0 | 123.7 MB (pkg) | 150 ms | **542 ms** | — | 69 MB |
| goose | 1.51.0 | 312.5 MB | 7 ms | **7 ms** | **0 ms** | — |
| aider | aider 0.86.2 | 642.8 MB (pkg) | 806 ms | **738 ms** | **11 ms** | 67 MB |
| amp | n/a (not installed) | — | — | — | — | — |
| cursor-agent | n/a (not installed) | — | — | — | — | — |
| qwen code | 0.24.2 | 154.1 MB (pkg) | 38 ms | **1565 ms** | — | 26 MB |
| codebuff | n/a (not installed) | — | — | — | — | — |
| kilo code | 7.7.6 | 540.3 MB (pkg) | 999 ms | **1788 ms** | **48 ms** | 46 MB |

fox-agent headless vs scripted local provider: time to first token **54 ms**, peak RSS **58 MB**.

_Generated 2026-09-21T13:58:53Z on Linux x86_64 (6.17.0-1022-azure). [How this is measured](#benchmarks) · [raw JSON](bench/results.json)_
<!-- bench:end -->
