...
|---|---|---|---|---|---|---|
| **fox-agent** | 0.5.0-beta.1 | 89.2 MB | 13 ms | **15 ms** | — | 36 MB |
| claude code | 2.1.280 (Claude Code) | 233.7 MB | 8 ms | **183 ms** | — | 172 MB |
| codex | codex-cli 0.156.1 | 386.9 MB (pkg) | 43 ms | **46 ms** | — | 49 MB |
| opencode v1 | 1.18.32 | 185.2 MB | 564 ms | **948 ms** | **40 ms** | 366 MB |
| opencode v2 | opencode2 v0.0.0-beta-19271 | 207.4 MB | 79 ms | **133 ms** | **59 ms** | 126 MB |
| jcode | jcode v0.88.0 (ee4cd3db3) | 130.1 MB | 9 ms | **12 ms** | — | 24 MB |
| pi | 0.87.1 | 403.5 MB (pkg) | 225 ms | **280 ms** | **7 ms** | 142 MB |
| gemini cli | 0.60.0 | 102.0 MB (pkg) | 1438 ms | **1507 ms** | **0 ms** | 146 MB |
| copilot cli | GitHub Copilot CLI 1.0.88. | 169.6 MB (pkg) | 597 ms | **699 ms** | — | 47 MB |
| crush | crush version v0.96.1 | 123.7 MB (pkg) | 150 ms | **435 ms** | — | 69 MB |
| goose | 1.51.0 | 312.5 MB | 8 ms | **8 ms** | **0 ms** | — |
| aider | aider 0.86.2 | 642.8 MB (pkg) | 778 ms | **702 ms** | **10 ms** | 67 MB |
| amp | n/a (not installed) | — | — | — | — | — |
| cursor-agent | n/a (not installed) | — | — | — | — | — |
| qwen code | 0.24.4 | 154.6 MB (pkg) | 40 ms | **1593 ms** | — | 26 MB |
| codebuff | n/a (not installed) | — | — | — | — | — |
| kilo code | 7.7.9 | 542.5 MB (pkg) | 999 ms | **1720 ms** | **45 ms** | 46 MB |

fox-agent headless vs scripted local provider: time to first token **47 ms**, peak RSS **59 MB**.

_Generated 2026-09-23T13:04:15Z on Linux x86_64 (6.17.0-1022-azure). [How this is measured](#benchmarks) · [raw JSON](bench/results.json)_
<!-- bench:end -->
