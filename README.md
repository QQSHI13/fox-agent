...
|---|---|---|---|---|---|
| **fox-agent** | 0.4.0 | 88.9 MB | 11 ms | **13 ms** | 34 MB |
| claude code | 2.1.270 (Claude Code) | 224.0 MB | 8 ms | **206 ms** | 176 MB |
| codex | codex-cli 0.154.0 | 339.1 MB (pkg) | 41 ms | **39 ms** | 49 MB |
| opencode v1 | 1.18.30 | 184.8 MB | 577 ms | **958 ms** | 365 MB |
| opencode v2 | opencode2 v0.0.0-beta-19271 | 207.4 MB | 80 ms | **136 ms** | 97 MB |
| jcode | jcode v0.84.0 (57d587899) | 0.0 MB (entry) | 8 ms | **16 ms** | 29 MB |
| pi | 0.85.1 | 415.1 MB (pkg) | 272 ms | **325 ms** | 130 MB |
| gemini cli | 0.59.0 | 101.8 MB (pkg) | 1350 ms | **1443 ms** | — |
| copilot cli | GitHub Copilot CLI 1.0.83. | 309.5 MB (pkg) | 561 ms | **650 ms** | 47 MB |
| crush | crush version v0.94.1 | 122.1 MB (pkg) | 139 ms | **458 ms** | 68 MB |
| goose | 1.50.0 | 314.5 MB | 6 ms | **6 ms** | 25 MB |
| aider | aider 0.86.2 | 642.8 MB (pkg) | 722 ms | **636 ms** | 69 MB |
| amp | n/a (not installed) | — | — | — | — |
| cursor-agent | n/a (not installed) | — | — | — | — |
| qwen code | 0.23.3 | 138.0 MB (pkg) | 36 ms | **1406 ms** | 27 MB |
| codebuff | n/a (not installed) | — | — | — | — |
| kilo code | 7.6.2 | 538.8 MB (pkg) | 1004 ms | **1819 ms** | 46 MB |

fox-agent headless vs scripted local provider: time to first token **56 ms**, peak RSS **58 MB**.

_Generated 2026-09-14T12:56:57Z on Linux x86_64 (6.17.0-1022-azure). [How this is measured](#benchmarks) · [raw JSON](bench/results.json)_
<!-- bench:end -->
