...
| claude code | 2.1.276 (Claude Code) | 232.1 MB | 10 ms | **203 ms** | 184 MB |
| codex | codex-cli 0.155.0 | 370.6 MB (pkg) | 43 ms | **41 ms** | 49 MB |
| opencode v1 | 1.18.31 | 185.0 MB | 583 ms | **954 ms** | 359 MB |
| opencode v2 | opencode2 v0.0.0-beta-19271 | 207.4 MB | 79 ms | **130 ms** | 97 MB |
| jcode | jcode v0.84.0 (57d587899) | 0.0 MB (entry) | 11 ms | **13 ms** | 29 MB |
| pi | 0.85.1 | 415.1 MB (pkg) | 290 ms | **346 ms** | 146 MB |
| gemini cli | 0.60.0 | 102.0 MB (pkg) | 1453 ms | **1546 ms** | 146 MB |
| copilot cli | GitHub Copilot CLI 1.0.86. | 166.8 MB (pkg) | 580 ms | **700 ms** | 47 MB |
| crush | crush version v0.95.0 | 122.4 MB (pkg) | 152 ms | **562 ms** | 68 MB |
| goose | 1.51.0 | 312.5 MB | 8 ms | **8 ms** | 25 MB |
| aider | aider 0.86.2 | 642.8 MB (pkg) | 788 ms | **717 ms** | 69 MB |
| amp | n/a (not installed) | — | — | — | — |
| cursor-agent | n/a (not installed) | — | — | — | — |
| qwen code | 0.24.0 | 140.7 MB (pkg) | 40 ms | **1584 ms** | 27 MB |
| codebuff | n/a (not installed) | — | — | — | — |
| kilo code | 7.7.5 | 539.9 MB (pkg) | 1005 ms | **1725 ms** | 46 MB |

fox-agent headless vs scripted local provider: time to first token **53 ms**, peak RSS **58 MB**.

_Generated 2026-09-18T12:24:43Z on Linux x86_64 (6.17.0-1022-azure). [How this is measured](#benchmarks) · [raw JSON](bench/results.json)_
<!-- bench:end -->
