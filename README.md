...
|---|---|---|---|---|---|---|
| **fox-agent** | 0.5.0-beta.1 | 89.2 MB | 11 ms | **12 ms** | — | 33 MB |
| claude code | 2.1.282 (Claude Code) | 238.8 MB | 10 ms | **128 ms** | — | 174 MB |
| codex | codex-cli 0.157.0 | 391.2 MB (pkg) | 31 ms | **32 ms** | — | 49 MB |
| opencode v1 | 1.18.32 | 185.2 MB | 388 ms | **644 ms** | **30 ms** | 356 MB |
| opencode v2 | opencode2 v0.0.0-beta-19271 | 207.4 MB | 61 ms | **93 ms** | **40 ms** | 123 MB |
| jcode | jcode v0.88.0 (ee4cd3db3) | 130.1 MB | 7 ms | **9 ms** | — | 24 MB |
| pi | 0.87.1 | 403.5 MB (pkg) | 146 ms | **184 ms** | **5 ms** | 144 MB |
| gemini cli | 0.61.0 | 102.1 MB (pkg) | 934 ms | **991 ms** | **0 ms** | — |
| copilot cli | GitHub Copilot CLI 1.0.88. | 169.6 MB (pkg) | 389 ms | **456 ms** | — | 47 MB |
| crush | crush version v0.96.1 | 123.7 MB (pkg) | 101 ms | **488 ms** | — | 68 MB |
| goose | 1.52.0 | 300.8 MB | 7 ms | **7 ms** | **0 ms** | — |
| aider | aider 0.86.2 | 642.8 MB (pkg) | 609 ms | **476 ms** | **6 ms** | 67 MB |
| amp | n/a (not installed) | — | — | — | — | — |
| cursor-agent | n/a (not installed) | — | — | — | — | — |
| qwen code | 0.24.5 | 155.0 MB (pkg) | 27 ms | **739 ms** | — | 23 MB |
| codebuff | n/a (not installed) | — | — | — | — | — |
| kilo code | 7.7.9 | 542.5 MB (pkg) | 706 ms | **1184 ms** | **31 ms** | 46 MB |

fox-agent headless vs scripted local provider: time to first token **40 ms**, peak RSS **58 MB**.

_Generated 2026-09-25T04:10:57Z on Linux x86_64 (6.17.0-1022-azure). [How this is measured](#benchmarks) · [raw JSON](bench/results.json)_
<!-- bench:end -->
