...
|---|---|---|---|---|---|---|
| **fox-agent** | 0.5.0-beta.1 | 89.2 MB | 12 ms | **13 ms** | — | 35 MB |
| claude code | 2.1.280 (Claude Code) | 233.7 MB | 7 ms | **181 ms** | — | 172 MB |
| codex | codex-cli 0.156.1 | 386.9 MB (pkg) | 39 ms | **45 ms** | — | 49 MB |
| opencode v1 | 1.18.32 | 185.2 MB | 575 ms | **962 ms** | **40 ms** | 366 MB |
| opencode v2 | opencode2 v0.0.0-beta-19271 | 207.4 MB | 79 ms | **133 ms** | **64 ms** | 128 MB |
| jcode | jcode v0.88.0 (ee4cd3db3) | 130.1 MB | 8 ms | **10 ms** | — | 23 MB |
| pi | 0.87.1 | 403.5 MB (pkg) | 217 ms | **271 ms** | **7 ms** | 147 MB |
| gemini cli | 0.60.0 | 102.0 MB (pkg) | 1370 ms | **1442 ms** | **0 ms** | — |
| copilot cli | GitHub Copilot CLI 1.0.88. | 169.6 MB (pkg) | 566 ms | **683 ms** | — | 47 MB |
| crush | crush version v0.96.1 | 123.7 MB (pkg) | 138 ms | **488 ms** | — | 69 MB |
| goose | 1.51.0 | 312.5 MB | 6 ms | **6 ms** | **0 ms** | — |
| aider | aider 0.86.2 | 642.8 MB (pkg) | 718 ms | **638 ms** | **9 ms** | 67 MB |
| amp | n/a (not installed) | — | — | — | — | — |
| cursor-agent | n/a (not installed) | — | — | — | — | — |
| qwen code | 0.24.4 | 154.6 MB (pkg) | 36 ms | **1454 ms** | — | 26 MB |
| codebuff | n/a (not installed) | — | — | — | — | — |
| kilo code | 7.7.9 | 542.5 MB (pkg) | 1035 ms | **1758 ms** | **46 ms** | 46 MB |

fox-agent headless vs scripted local provider: time to first token **52 ms**, peak RSS **58 MB**.

_Generated 2026-09-23T14:31:13Z on Linux x86_64 (6.17.0-1022-azure). [How this is measured](#benchmarks) · [raw JSON](bench/results.json)_
<!-- bench:end -->
