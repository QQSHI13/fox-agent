...
| claude code | 2.1.281 (Claude Code) | 237.4 MB | 7 ms | **188 ms** | — | 173 MB |
| codex | codex-cli 0.156.1 | 386.9 MB (pkg) | 41 ms | **43 ms** | — | 49 MB |
| opencode v1 | 1.18.32 | 185.2 MB | 554 ms | **937 ms** | **40 ms** | 359 MB |
| opencode v2 | opencode2 v0.0.0-beta-19271 | 207.4 MB | 77 ms | **130 ms** | **62 ms** | 126 MB |
| jcode | jcode v0.88.0 (ee4cd3db3) | 130.1 MB | 8 ms | **10 ms** | — | 24 MB |
| pi | 0.87.1 | 403.5 MB (pkg) | 212 ms | **267 ms** | **7 ms** | 146 MB |
| gemini cli | 0.61.0 | 102.1 MB (pkg) | 1326 ms | **1412 ms** | **0 ms** | — |
| copilot cli | GitHub Copilot CLI 1.0.88. | 169.6 MB (pkg) | 554 ms | **670 ms** | — | 47 MB |
| crush | crush version v0.96.1 | 123.7 MB (pkg) | 137 ms | **343 ms** | — | 68 MB |
| goose | 1.52.0 | 300.8 MB | 6 ms | **6 ms** | **0 ms** | — |
| aider | aider 0.86.2 | 642.8 MB (pkg) | 700 ms | **624 ms** | **9 ms** | 67 MB |
| amp | n/a (not installed) | — | — | — | — | — |
| cursor-agent | n/a (not installed) | — | — | — | — | — |
| qwen code | 0.24.4 | 154.6 MB (pkg) | 36 ms | **1450 ms** | — | 26 MB |
| codebuff | n/a (not installed) | — | — | — | — | — |
| kilo code | 7.7.9 | 542.5 MB (pkg) | 1008 ms | **1728 ms** | **47 ms** | 46 MB |

fox-agent headless vs scripted local provider: time to first token **53 ms**, peak RSS **58 MB**.

_Generated 2026-09-24T12:33:59Z on Linux x86_64 (6.17.0-1022-azure). [How this is measured](#benchmarks) · [raw JSON](bench/results.json)_
<!-- bench:end -->
