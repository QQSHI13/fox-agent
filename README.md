...
|---|---|---|---|---|---|---|
| **fox-agent** | 0.5.0-beta.1 | 89.2 MB | 10 ms | **12 ms** | — | 35 MB |
| claude code | 2.1.281 (Claude Code) | 237.4 MB | 7 ms | **173 ms** | — | 173 MB |
| codex | codex-cli 0.156.1 | 386.9 MB (pkg) | 38 ms | **41 ms** | — | 49 MB |
| opencode v1 | 1.18.32 | 185.2 MB | 526 ms | **885 ms** | **37 ms** | 364 MB |
| opencode v2 | opencode2 v0.0.0-beta-19271 | 207.4 MB | 74 ms | **120 ms** | **60 ms** | 128 MB |
| jcode | jcode v0.88.0 (ee4cd3db3) | 130.1 MB | 7 ms | **9 ms** | — | 24 MB |
| pi | 0.87.1 | 403.5 MB (pkg) | 197 ms | **248 ms** | **6 ms** | 147 MB |
| gemini cli | 0.61.0 | 102.1 MB (pkg) | 1238 ms | **1315 ms** | — | — |
| copilot cli | GitHub Copilot CLI 1.0.88. | 169.6 MB (pkg) | 514 ms | **617 ms** | — | 47 MB |
| crush | crush version v0.96.1 | 123.7 MB (pkg) | 130 ms | **460 ms** | — | 68 MB |
| goose | 1.52.0 | 300.8 MB | 6 ms | **6 ms** | **0 ms** | — |
| aider | aider 0.86.2 | 642.8 MB (pkg) | 653 ms | **580 ms** | **9 ms** | 67 MB |
| amp | n/a (not installed) | — | — | — | — | — |
| cursor-agent | n/a (not installed) | — | — | — | — | — |
| qwen code | 0.24.4 | 154.6 MB (pkg) | 33 ms | **1345 ms** | — | 26 MB |
| codebuff | n/a (not installed) | — | — | — | — | — |
| kilo code | 7.7.9 | 542.5 MB (pkg) | 940 ms | **1625 ms** | **46 ms** | 46 MB |

fox-agent headless vs scripted local provider: time to first token **51 ms**, peak RSS **58 MB**.

_Generated 2026-09-24T11:22:04Z on Linux x86_64 (6.17.0-1022-azure). [How this is measured](#benchmarks) · [raw JSON](bench/results.json)_
<!-- bench:end -->
