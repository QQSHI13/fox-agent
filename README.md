...
| claude code | 2.1.274 (Claude Code) | 230.6 MB | 7 ms | **182 ms** | 183 MB |
| codex | codex-cli 0.154.0 | 339.1 MB (pkg) | 34 ms | **33 ms** | 49 MB |
| opencode v1 | 1.18.31 | 185.0 MB | 506 ms | **851 ms** | 361 MB |
| opencode v2 | opencode2 v0.0.0-beta-19271 | 207.4 MB | 69 ms | **120 ms** | 97 MB |
| jcode | jcode v0.84.0 (57d587899) | 0.0 MB (entry) | 7 ms | **9 ms** | 27 MB |
| pi | 0.85.1 | 415.1 MB (pkg) | 238 ms | **284 ms** | 145 MB |
| gemini cli | 0.60.0 | 102.0 MB (pkg) | 1217 ms | **1300 ms** | — |
| copilot cli | GitHub Copilot CLI 1.0.85. | 166.5 MB (pkg) | 498 ms | **592 ms** | 47 MB |
| crush | crush version v0.95.0 | 122.4 MB (pkg) | 131 ms | **511 ms** | 68 MB |
| goose | 1.50.1 | 314.6 MB | 5 ms | **5 ms** | 26 MB |
| aider | aider 0.86.2 | 642.8 MB (pkg) | 611 ms | **550 ms** | 69 MB |
| amp | n/a (not installed) | — | — | — | — |
| cursor-agent | n/a (not installed) | — | — | — | — |
| qwen code | 0.24.0 | 140.7 MB (pkg) | 32 ms | **1289 ms** | 26 MB |
| codebuff | n/a (not installed) | — | — | — | — |
| kilo code | 7.7.3 | 539.9 MB (pkg) | 897 ms | **1538 ms** | 46 MB |

fox-agent headless vs scripted local provider: time to first token **708 ms**, peak RSS **58 MB**.

_Generated 2026-09-17T11:54:30Z on Linux x86_64 (6.17.0-1022-azure). [How this is measured](#benchmarks) · [raw JSON](bench/results.json)_
<!-- bench:end -->
