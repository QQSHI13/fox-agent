...
| claude code | 2.1.281 (Claude Code) | 237.4 MB | 8 ms | **148 ms** | — | 174 MB |
| codex | codex-cli 0.156.1 | 386.9 MB (pkg) | 35 ms | **37 ms** | — | 49 MB |
| opencode v1 | 1.18.32 | 185.2 MB | 443 ms | **745 ms** | **31 ms** | 356 MB |
| opencode v2 | opencode2 v0.0.0-beta-19271 | 207.4 MB | 63 ms | **103 ms** | **48 ms** | 126 MB |
| jcode | jcode v0.88.0 (ee4cd3db3) | 130.1 MB | 8 ms | **10 ms** | — | 24 MB |
| pi | 0.87.1 | 403.5 MB (pkg) | 176 ms | **219 ms** | **6 ms** | 142 MB |
| gemini cli | 0.60.0 | 102.0 MB (pkg) | 1125 ms | **1190 ms** | **0 ms** | — |
| copilot cli | GitHub Copilot CLI 1.0.88. | 169.6 MB (pkg) | 461 ms | **543 ms** | — | 47 MB |
| crush | crush version v0.96.1 | 123.7 MB (pkg) | 119 ms | **507 ms** | — | 69 MB |
| goose | 1.52.0 | 300.8 MB | 6 ms | **6 ms** | **0 ms** | — |
| aider | aider 0.86.2 | 642.8 MB (pkg) | 603 ms | **545 ms** | **8 ms** | 67 MB |
| amp | n/a (not installed) | — | — | — | — | — |
| cursor-agent | n/a (not installed) | — | — | — | — | — |
| qwen code | 0.24.4 | 154.6 MB (pkg) | 30 ms | **1228 ms** | — | 26 MB |
| codebuff | n/a (not installed) | — | — | — | — | — |
| kilo code | 7.7.9 | 542.5 MB (pkg) | 769 ms | **1346 ms** | **35 ms** | 46 MB |

fox-agent headless vs scripted local provider: time to first token **83 ms**, peak RSS **58 MB**.

_Generated 2026-09-23T23:38:48Z on Linux x86_64 (6.17.0-1022-azure). [How this is measured](#benchmarks) · [raw JSON](bench/results.json)_
<!-- bench:end -->
