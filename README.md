...
|---|---|---|---|---|---|---|
| **fox-agent** | 0.5.0-beta.1 | 89.2 MB | 13 ms | **16 ms** | — | 32 MB |
| claude code | 2.1.283 (Claude Code) | 241.6 MB | 9 ms | **190 ms** | — | 173 MB |
| codex | codex-cli 0.157.1 | 391.1 MB (pkg) | 44 ms | **46 ms** | — | 49 MB |
| opencode v1 | 1.18.32 | 185.2 MB | 591 ms | **968 ms** | **41 ms** | 364 MB |
| opencode v2 | opencode2 v0.0.0-beta-19271 | 207.4 MB | 84 ms | **137 ms** | **60 ms** | 130 MB |
| jcode | jcode v0.88.0 (ee4cd3db3) | 130.1 MB | 9 ms | **12 ms** | — | 24 MB |
| pi | 0.87.1 | 403.5 MB (pkg) | 223 ms | **279 ms** | **7 ms** | 147 MB |
| gemini cli | 0.61.0 | 102.1 MB (pkg) | 1433 ms | **1507 ms** | **0 ms** | 146 MB |
| copilot cli | GitHub Copilot CLI 1.0.88. | 169.6 MB (pkg) | 591 ms | **691 ms** | — | 47 MB |
| crush | crush version v0.96.1 | 123.7 MB (pkg) | 151 ms | **558 ms** | — | 69 MB |
| goose | 1.52.0 | 300.8 MB | 8 ms | **8 ms** | **0 ms** | — |
| aider | aider 0.86.2 | 642.8 MB (pkg) | 773 ms | **704 ms** | **10 ms** | 67 MB |
| amp | n/a (not installed) | — | — | — | — | — |
| cursor-agent | n/a (not installed) | — | — | — | — | — |
| qwen code | 0.24.6 | 138.1 MB (pkg) | 39 ms | **761 ms** | — | 254 MB |
| codebuff | n/a (not installed) | — | — | — | — | — |
| kilo code | 7.8.1 | 542.5 MB (pkg) | 1010 ms | **1741 ms** | **47 ms** | 46 MB |

fox-agent headless vs scripted local provider: time to first token **47 ms**, peak RSS **59 MB**.

_Generated 2026-09-26T06:42:39Z on Linux x86_64 (6.17.0-1022-azure). [How this is measured](#benchmarks) · [raw JSON](bench/results.json)_
<!-- bench:end -->
