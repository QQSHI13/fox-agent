...
|---|---|---|---|---|---|
| **fox-agent** | 0.4.0 | 89.1 MB | 14 ms | **15 ms** | 35 MB |
| claude code | 2.1.278 (Claude Code) | 234.1 MB | 10 ms | **206 ms** | 185 MB |
| codex | codex-cli 0.155.1 | 370.5 MB (pkg) | 45 ms | **41 ms** | 49 MB |
| opencode v1 | 1.18.31 | 185.0 MB | 532 ms | **903 ms** | 365 MB |
| opencode v2 | opencode2 v0.0.0-beta-19271 | 207.4 MB | 70 ms | **131 ms** | 97 MB |
| jcode | jcode v0.86.0 (e589cbe5a) | 0.0 MB (entry) | 10 ms | **13 ms** | 27 MB |
| pi | 0.86.1 | 402.9 MB (pkg) | 199 ms | **272 ms** | 151 MB |
| gemini cli | 0.60.0 | 102.0 MB (pkg) | 1479 ms | **1498 ms** | 146 MB |
| copilot cli | GitHub Copilot CLI 1.0.86. | 166.8 MB (pkg) | 555 ms | **685 ms** | 47 MB |
| crush | crush version v0.96.0 | 123.7 MB (pkg) | 141 ms | **288 ms** | 69 MB |
| goose | 1.51.0 | 312.5 MB | 8 ms | **8 ms** | 26 MB |
| aider | aider 0.86.2 | 642.8 MB (pkg) | 752 ms | **676 ms** | 69 MB |
| amp | n/a (not installed) | — | — | — | — |
| cursor-agent | n/a (not installed) | — | — | — | — |
| qwen code | 0.24.2 | 154.1 MB (pkg) | 35 ms | **1520 ms** | 26 MB |
| codebuff | n/a (not installed) | — | — | — | — |
| kilo code | 7.7.5 | 539.9 MB (pkg) | 994 ms | **1837 ms** | 46 MB |

fox-agent headless vs scripted local provider: time to first token **58 ms**, peak RSS **58 MB**.

_Generated 2026-09-21T12:36:43Z on Linux x86_64 (6.17.0-1022-azure). [How this is measured](#benchmarks) · [raw JSON](bench/results.json)_
<!-- bench:end -->
