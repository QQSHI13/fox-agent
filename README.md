...
|---|---|---|---|---|---|
| **fox-agent** | 0.4.0 | 89.0 MB | 12 ms | **13 ms** | 35 MB |
| claude code | 2.1.274 (Claude Code) | 230.6 MB | 7 ms | **204 ms** | 183 MB |
| codex | codex-cli 0.154.0 | 339.1 MB (pkg) | 39 ms | **37 ms** | 49 MB |
| opencode v1 | 1.18.31 | 185.0 MB | 579 ms | **951 ms** | 363 MB |
| opencode v2 | opencode2 v0.0.0-beta-19271 | 207.4 MB | 74 ms | **123 ms** | 98 MB |
| jcode | jcode v0.84.0 (57d587899) | 0.0 MB (entry) | 8 ms | **10 ms** | 28 MB |
| pi | 0.85.1 | 415.1 MB (pkg) | 272 ms | **330 ms** | 130 MB |
| gemini cli | 0.60.0 | 102.0 MB (pkg) | 1404 ms | **1471 ms** | 146 MB |
| copilot cli | GitHub Copilot CLI 1.0.85. | 166.5 MB (pkg) | 568 ms | **680 ms** | 47 MB |
| crush | crush version v0.95.0 | 122.4 MB (pkg) | 139 ms | **462 ms** | 69 MB |
| goose | 1.50.1 | 314.6 MB | 6 ms | **6 ms** | 26 MB |
| aider | aider 0.86.2 | 642.8 MB (pkg) | 722 ms | **647 ms** | 69 MB |
| amp | n/a (not installed) | — | — | — | — |
| cursor-agent | n/a (not installed) | — | — | — | — |
| qwen code | 0.24.0 | 140.7 MB (pkg) | 35 ms | **1525 ms** | 27 MB |
| codebuff | n/a (not installed) | — | — | — | — |
| kilo code | 7.7.3 | 539.9 MB (pkg) | 1027 ms | **1788 ms** | 46 MB |

fox-agent headless vs scripted local provider: time to first token **47 ms**, peak RSS **58 MB**.

_Generated 2026-09-17T12:36:49Z on Linux x86_64 (6.17.0-1022-azure). [How this is measured](#benchmarks) · [raw JSON](bench/results.json)_
<!-- bench:end -->
